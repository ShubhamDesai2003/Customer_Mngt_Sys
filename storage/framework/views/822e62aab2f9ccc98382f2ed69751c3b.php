...
unset($__errorArgs, $__bag); ?>" id="order_number" name="order_number" value="<?php echo e(old('order_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="amount" name="amount" step="0.01" value="<?php echo e(old('amount')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control <?php $__errorArgs = ['order_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="order_date" name="order_date" value="<?php echo e(old('order_date', now()->format('Y-m-d\TH:i'))); ?>" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Zoro\Luffy\Projects\impact-guru-crm\resources\views/orders/create.blade.php ENDPATH**/ ?>