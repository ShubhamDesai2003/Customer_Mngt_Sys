...
<div class="row mb-4">
    ...
    <div class="col-md-4 text-end">
        <a href="<?php echo e(route('customers.index')); ?>" class="btn btn-secondary">Back to Customers</a>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Zoro\Luffy\Projects\impact-guru-crm\resources\views/customers/create.blade.php ENDPATH**/ ?>