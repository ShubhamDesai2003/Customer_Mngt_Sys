    ...
    <div class="card-body">
        <form method="POST" action="{{ route('orders.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control @error('order_date') is-invalid @enderror" id="order_date" name="order_date" value="{{ old('order_date', now()->format('Y-m-d\TH:i')) }}" required>
